...
export default class RelatedProductsContent extends Component {
                ...
                {(value) => (
                    <div className="product-item text-center">
                        <div className="product-img" onClick={() =>
                            ...
                            <img src={images} className="product__img" alt="Shop" />
...
RelatedProductsContent.propTypes = {
