                    ...
                    <div className="signup-form-box">
                        ...
                        <form className="signup-form">
                            ...
                            <div className="checkboxes">
                                <label className="privacy-policy"> I agree to SHK Law's <a href="https://techydevs.com">Privacy Policy</a>
                                    <input type="checkbox" />
                                    <span className="checkmark"></span>
                                </label>
                                <label className="privacy-policy"> I agree to SHK Law's <a href="https://techydevs.com">Terms of Services</a>
                                    <input type="checkbox" />
                                    <span className="checkmark"></span>
                                </label>
                            </div>
