...
import pt1 from '../../assets/images/img22.jpg'
                ...
                <div className="portfolio-grid-wrapper">
                    <div className="container">
                        <div className="portfolio-grid-top text-center">
                            <SectionsTitle title="We've Done Lot's of Work, Let's Check Some From here." subtitle="Get To Know" />
                            <div className="filters">
                                <button
                                    onClick={this.handleClickAll}
                                    className={
                                        this.state.isClickedAll
                                            ? classNames("all active")
                                            : "all "
                                    } >
                                    All
                            </button>
                        ...
                        <div className="grid">
                            <div className="grid-item portfolio-item consulting business">
                                <img src={pt1} alt="Portfolio Grid" />
